<script setup>
  ...
  async function fetchRegionalReport () {
    try {
      ...
      console.error('AISummary: fetchRegionalReport error', error)
    }
  }
  ...
  function startPolling () {
    ...
    if (props.isOverview) {
      ...
      setTimeout(() => {
        isGenerating.value = false; emit('generated')
      }, 4000)
    }
  }
  ...
  onMounted(() => {
    if (props.isOverview) fetchRegionalReport()
  })
  onUnmounted(() => {
    stopPolling()
  })

  watch(() => props.isOverview, nv => {
    if (nv) fetchRegionalReport()
  })
  ...
  <div>
    <div class="d-flex align-center justify-space-between mb-3">
      <div class="d-flex align-center">
        <VIcon class="mr-2" color="primary">mdi-brain</VIcon>
    ...
    <div
      v-if="isGenerating && !formattedSummary"
      class="summary-card d-flex flex-column align-center justify-center py-8"
    >
      <VIcon class="mb-2" color="grey-lighten-1" size="large">mdi-creation</VIcon>
    ...
    <div v-else-if="formattedSummary" class="summary-card">
      ...
      <div class="d-flex justify-space-between align-center mb-3">
        <div class="d-flex align-center">
          <VIcon class="mr-1" color="grey-darken-1" size="small">mdi-calendar-check</VIcon>
        ...
        <div class="d-flex align-center">
          <VChip
            v-if="props.isOverview && regionalReport"
          ...
          <VChip
            v-else-if="!props.isOverview && farmTotalMPs > 0"
            class="font-weight-bold"
      ...
      >
        <div class="report-content" v-html="formattedSummary" />
    ...
    <VDialog v-model="showReportDialog" max-width="850" scrollable>
      <VCard>
        <VCardTitle class="d-flex justify-space-between align-center pa-4 bg-grey-lighten-4">
          <div class="d-flex align-center">
            <VIcon class="mr-2" color="primary">mdi-google-analytics</VIcon>
            <span class="text-h6 font-weight-bold">
              {{ props.isOverview ? 'Regional Intelligence Report' : 'Site Diagnostic Report' }}
            </span>
          </div>
          <VBtn icon="mdi-close" variant="text" @click="showReportDialog = false" />
        </VCardTitle>
        <VDivider />
            ...
            <div class="stats-grid mb-6">
              <div class="stat-card bg-blue-lighten-5">
                <div class="d-flex align-center text-primary mb-1">
                  <VIcon class="mr-1" size="small">mdi-calendar-clock</VIcon>
              ...
              <div class="stat-card bg-grey-lighten-4">
                <div class="d-flex align-center text-grey-darken-2 mb-1">
                  <VIcon class="mr-1" size="small">{{ isOverview ? 'mdi-map' : 'mdi-flower-tulip' }}
                  </VIcon>
              ...
              <div class="stat-card bg-red-lighten-5">
                <div class="d-flex align-center text-red-darken-2 mb-1">
                  <VIcon class="mr-1" size="small">mdi-alert-circle-outline</VIcon>

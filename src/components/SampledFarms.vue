...
function initMap() {
    ...
    try {
        ...
        fetch(geoUrl)
            ...
            .catch((err) => console.warn('Could not fetch Tayabas.geojson', err))
    } catch (e) {
        console.warn('Could not build Tayabas.geojson URL', e)
    }
...
<template>
    <div>
        <div class="list-controls">
            ...
            <button class="sort-btn" @click="toggleSort" title="Toggle sort">
        ...
        <div class="map-wrap" v-if="props.showMap">

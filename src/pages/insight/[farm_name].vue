                ...
                <div class="d-flex flex-column ga-4">
                    ...
                    <div class="card">
                        <SiteDrilldownChart :categories="anonymizedComparison.categories"
                            ...
                            :colors="mpColors" :date="displaySampleDate" :drilldown="anonymizedComparison.drilldown"
                            :height="320"
                ...
                <div class="d-flex flex-column ga-4">
                    ...
                    <div class="card">
                        <SiteDrilldownChart :categories="colorComparison.categories"
                            :category-labels="['Fragments', 'Fibers', 'Foam', 'Films', 'Sheets', 'Pellets']"
                            :colors="mpColors" :date="displaySampleDate" :drilldown="colorComparison.drilldown"
                            :height="260" title="Microplastic Count by Color" :totals="colorComparison.totals" />
                    </div>
                    <div class="card">

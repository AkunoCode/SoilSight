      ...
      <VCol cols="4">
        <div class="card">
          ...
          <div v-if="farm?.latitude != null && farm?.longitude != null">
            <LeafletMap
              :lat="farm?.latitude != null ? Number(farm.latitude) : null"
              :lng="farm?.longitude != null ? Number(farm.longitude) : null"
              :zoom="13"
            />
          </div>
    ...
    <VRow>
      ...
      <VCol cols="7">
        <div class="d-flex flex-column ga-4">
          ...
          <div class="card">
            <SiteDrilldownChart
              :categories="colorComparison.categories"
              :category-labels="['Fragments', 'Fibers', 'Foam', 'Films', 'Sheets', 'Pellets']"
              :colors="mpColors"
              :date="displaySampleDate"

...
<script setup>
// Intentionally empty - this is a static, non-dismissible warning page.
</script>
...
.mobile-warning-page h1 {
    margin: 0 0 0.5rem;
    font-size: 1.5rem;
}

.mobile-warning-page p {
    margin: 0.5rem 0;
    color: #333;
}

.mobile-warning-page .muted {
    color: #666;
    margin-top: 1rem;
    font-size: 0.95rem
}
